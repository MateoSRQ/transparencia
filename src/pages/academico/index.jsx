                ...
                <div className="container mx-auto">
                    ...
                    >
                        <h1 style={{
                            ...
                            letterSpacing: '-1.9px',
                            lineHeight: '40px'
                        }}>NÚMERO DE MATRICULADOS POR AÑO Y CARRERA
                        </h1>
                    </div>
                    ...
                    >
                        <h1 style={{
                            ...
                            letterSpacing: '-1.9px',
                            lineHeight: '40px'
                        }}>NÚMERO DE EGRESADOS POR AÑO Y CARRERA
                        </h1>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 mx-auto"
                         style={{maxWidth: '600px', marginTop: '-30px', position: 'relative', margin: '0 auto'}}>
                        <a href="assets/files/NUMERO_EGRESADOS_2021-2.pdf">
                            <div>
                                <img src="assets/images/pdf.png" style={{transform: 'rotateZ(-0deg)', width: '42px'}}/>
                                <div style={{
                                    color: 'rgb(63,13,175)',
                    ...
                    {/*        letterSpacing: '-1.9px',*/}
                    {/*        lineHeight: '40px'*/}
                    {/*    }}>NÚMERO DE ESTUDIANTES POR FACULTAD y PROGRAMA DE ESTUDIOS*/}
                    {/*    </h1>*/}
                    {/*</div>*/}
                    ...
                    {/*                top: '-40px',*/}
                    {/*                left: '70px'*/}
                    {/*            }}>NÚMERO DE POSTULANTES MEDICINA 2022-1*/}
                    {/*            </div>*/}
                    {/*        </div>*/}
                    {/*    </a>*/}
                    {/*</div>*/}
