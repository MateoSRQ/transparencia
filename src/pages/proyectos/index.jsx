            ...
            <div className="flex justify-center bg-neutral-200 min-h-full" style={{minHeight: '1500px'}}>
                <div className="container mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 mx-auto"
                        ...
                        <a href="assets/files/POLÍTICA GENERAL DE INVESTIGACIÓN.pdf">
                            <div>
                                <img src="assets/images/pdf.png" style={{transform: 'rotateZ(-0deg)', width: '42px'}}/>
                                <div style={{
                                    color: 'rgb(63,13,175)',
                        ...
                        <a href="assets/files/PROCEDIMIENTO PARA GRUPOS DE INVESTIGACIÓN.pdf">
                            <div>
                                ...
                                <div style={{
                                    ...
                                    top: '-40px',
                                    left: '70px'
                                }}>PROCEDIMIENTO PARA GRUPOS DE INVESTIGACIÓN
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="assets/files/PROCEDIMIENTO PARA POSTULACIÓN DE PROYECTOS DE INVESTIGACIÓN.pdf">
                            <div>
                                ...
                                <div style={{
                                    ...
                                    top: '-40px',
                                    left: '70px'
                                }}>PROCEDIMIENTO PARA POSTULACIÓN DE PROYECTOS DE INVESTIGACIÓN
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="assets/files/CÓDIGO DE BIOÉTICA Y ÉTICA PARA LA INVESTIGACIÓN.pdf">
                            <div>
                                ...
                                <div style={{
                                    ...
                                    top: '-40px',
                                    left: '70px'
                                }}>CÓDIGO DE BIOÉTICA Y ÉTICA PARA LA INVESTIGACIÓN
                                </div>
                            </div>
                        </a>
                    </div>
