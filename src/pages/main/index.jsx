            ...
            <div className="flex justify-center bg-neutral-200 min-h-full" style={{minHeight: '1700px'}}>
                <div className="container mx-auto">
                            ...
                            >
                                ...
                                <div style={{
                                    ...
                                    <div className="text-center"
                                        ...
                                        Información sobre el Estatuto Universitario, el Estatuto Societario, Reglamento
                                        General y Plan Estratégico Institucional de la UAP
                                    </div>
                                </div>
                            </div>
                        </Link>
                        ...
                        <Link to="actas">
                            ...
                            >
                                ...
                                <div style={{
                                    ...
                                    <div className="text-center"
                                         style={{lineHeight: '15px', width: '90%', marginLeft: '5%'}}>
                                        Información sobre las Actas de Directorio y las Resoluciones Rectorales de la
                                        UAP
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="font-sans font-bolder text-center align-middle "
                         style={{
                             height: '105px',
                             borderTop: '1px solid rgb(139 92 246)',
                             fontSize: '42px',
                             marginTop: '50px'
                         }}
                    >
